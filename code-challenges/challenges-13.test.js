...
// Solution code here...
let newArray= ''; 
for(let stringArr of arr){
  if(stringArr.length > newArray.length){
newArray = stringArr;
  }
}
...
Write a function named firstLetters that takes in an array of strings and returns an array containing only the first.00 letter of each string.
